...
namespace WPFNA
{
    internal static class Win32Api
    {
        ...
        internal delegate int LowLevelMouseProc(int code, WM wParam, [In] MSLLHOOKSTRUCT lParam);
        ...
        [DllImport("user32.dll")]
        internal static extern int CallNextHookEx(IntPtr hhk, int nCode, WM wParam, [In] MSLLHOOKSTRUCT lParam);
